package com.apiobject.framwork.actions;
...
public class ApiActionModel {
    ...
    public Response run(ArrayList<String> actualParameter) {
         ...
         */
        if (query != null) {
            finalQuery.putAll(PlaceholderUtils.resolveMap(query, GlobalVariable.getGlobalVariables()));
        }
        //body全局变量替换
        runBody = PlaceholderUtils.resolveString(runBody, GlobalVariable.getGlobalVariables());
        //URL全局变量替换
        runUrl = PlaceholderUtils.resolveString(runUrl, GlobalVariable.getGlobalVariables());
        ...
        /**
         * 5拿到了上面完成了变量替换的请求数据，我们接下来要进行请求并返回结果
         */
